 ...
 */
package org.jonathanalvarez.report;
...
public class GenerarReporte {
    ...
    public void generarFactura(int factId) {
        try {
            ...
            InputStream jasperPath = GenerarReporte.class.getResourceAsStream("/org/jonathanalvarez/report/Factura.jasper");
    ...
    public void generarCliente() {
        try {
            conexion = Conexion.getInstance().obtenerConexion();
            InputStream jasperPath = GenerarReporte.class.getResourceAsStream("/org/jonathanalvarez/report/Cliente.jasper");
    ...
    public void generarProducto() {
        try {
            conexion = Conexion.getInstance().obtenerConexion();
            InputStream jasperPath = GenerarReporte.class.getResourceAsStream("/org/jonathanalvarez/report/Producto.jasper");
            JasperPrint reporte = JasperFillManager.fillReport(jasperPath, null, conexion);
            Stage reportStage = new Stage();
            JRViewerFX reportViewer = new JRViewerFX(reporte);
            Pane root = new Pane();
